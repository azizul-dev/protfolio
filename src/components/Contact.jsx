        ...
        >
          <div className="lg:w-[40%] bg-surface p-8 md:p-12 flex flex-col justify-between border-r border-border">
            <div className="space-y-12">
              <div>
                <h3 className="text-2xl font-bold text-foreground font-syne uppercase tracking-tight mb-8">
                  Contact Info
                </h3>
                <div className="space-y-8">
                  ...
                  <div className="flex items-center gap-6 group">
                    ...
                    <div>
                      ...
                      <div className="text-sm font-bold text-foreground">
                        abdulazizabdul8822@gmail.com
                      </div>
                    </div>
                  </div>
                  <a
                    href="https://wa.me/8801788224542"
                    target="_blank"
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                {[
                  {
                    name: "github",
                    url: "https://github.com/azizul-dev",
                    Icon: SiGithub,
                  },
                  {
                    name: "linkedin",
                  ...
                  { name: "x", url: "https://x.com/md_azizul63253", Icon: SiX },
                ].map((social, i) => (
                  <a
                    key={i}
                    href={social.url}
                  ...
                  >
                    <social.Icon className="w-5 h-5 text-gray-700 dark:text-gray-200 group-hover:text-primary transition-all" />
                  </a>
                ))}
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  <label className="text-[10px] font-mono uppercase tracking-[0.2em] text-muted ml-2">
                    Name
                  </label>
                  <input
                    name="name"
